...
/* Don't do steps 2-5.  Walker and Jones' 1987 study showed that weak
   stemming (step 1 only) tended to increase recall and doesn't
   significantly decrease precision, but strong stemming (all the rest
   of the steps) does hurt precision. Since we want good precision we
   don't want strong stemming.

   See William Frakes & Ricardo Baeza-Yates (eds) "Information
   Retrieval: Data Structures & Algorithms" 1992, p. 147
