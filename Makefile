...
pkgdatadir = $(datadir)/remem
pkglibdir = $(libdir)/remem
pkgincludedir = $(includedir)/remem
top_builddir = .
...
am__include = include
am__quote = 
install_sh = /Users/zzk/code/emacs/remem-2.12/install-sh
...
DIST_COMMON = README AUTHORS COPYING ChangeLog INSTALL Makefile.am \
	...
	configure.in depcomp elisp-comp install-sh missing \
	mkinstalldirs
